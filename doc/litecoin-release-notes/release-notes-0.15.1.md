Villanocoin Core version *0.15.1* is now available from:

  <https://download.villanocoin.org/villanocoin-0.15.1/>
...
A number of changes to the way Villanocoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 villanos per kB (0.00001 VLN). This is to prepare for dropping the minimum transaction fee to 0.1 villanos per kB (0.0001 VLN) in the next release.
