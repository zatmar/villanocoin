# Support for Output Descriptors in Villanocoin Core

Since Villanocoin Core v0.17, there is support for Output Descriptors. This is a
...
on Villanocoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Villanocoin Core wallets, a convenience function `combo` is
