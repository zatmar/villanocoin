...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.villanocoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.villanocointools.com");
        vSeeds.emplace_back("dnsseed.villanocoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.villanocointools.com");
        vSeeds.emplace_back("seed-b.villanocoin.loshan.co.uk");
