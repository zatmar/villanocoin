...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " villanocoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  villanocoin-tx [options] <hex-tx> [commands]  Update hex-encoded villanocoin transaction\n" +
            "or:     villanocoin-tx [options] -create [commands]   Create hex-encoded villanocoin transaction\n" +
            "\n";
