...
"""Verify that starting villanocoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start villanocoin with -h for help text")
        ...
        self.log.info("Start villanocoin with -version for version information")
        ...
        self.log.info("Start villanocoind with -fakearg to make sure it does not start")
